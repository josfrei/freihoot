        ...
        //    console.log("Pin recibido:" + datos.PIN)
            ...
            try {
                ...
                if (error.response && error.response.status === 404) {
                    ...
                    // Si el código de estado es 401, hay que introducir pin
                    alert("El PIN es obligatorio");
                } else if (error.response && error.response.status === 403) {
                    // Si el código de estado es 403, la partida está iniciada
                    alert("No puedes unirte a la partida porque la partida está iniciada");
                } else {
